...
const chapters: Chapter[] = [
  { title: 'JSON Specification Input', startTime: 0, icon: '📝' },
  { title: 'Feature Parsing', startTime: 30, icon: '⚙️' },
  { title: 'CAD Model Generation', startTime: 60, icon: '🔧' },
  { title: 'Export & Visualization', startTime: 90, icon: '📐' },
];

export default function Spec2CADVideo() {
  ...
  return (
    <div className="flex flex-col bg-black">
      ...
      <div className="relative aspect-video bg-gray-900">
        ...
        {showPlaceholder && (
          <div className="absolute inset-0 flex items-center justify-center bg-gradient-to-br from-slate-800 to-zinc-900 z-10">
            <div className="text-center">
              ...
              <h3 className="text-white text-xl font-bold mb-2">Spec2CAD Pipeline</h3>
              <p className="text-gray-300 text-sm mb-6">JSON specification to 3D CAD model generation</p>
              <button
                onClick={togglePlay}
        ...
        <video
          ...
          poster=""
        >
          <source src="/videos/spec2cad-demo.mp4" type="video/mp4" />
