...
const chapters: Chapter[] = [
  { title: 'Welcome & Chat Interface', startTime: 0, icon: '👋' },
  { title: 'Math Tutoring Demo', startTime: 30, icon: '🔢' },
  { title: 'Practice Test Mode', startTime: 60, icon: '📝' },
  { title: 'Progress Tracking', startTime: 90, icon: '📊' },
];
...
export default function BrainwaveVideo() {
  ...
  const [duration, setDuration] = useState(120); // 2:00 default
  ...
  return (
    <div className="flex flex-col bg-black">
      ...
      <div className="relative aspect-video bg-gray-900">
        ...
        {showPlaceholder && (
          <div className="absolute inset-0 flex items-center justify-center bg-gradient-to-br from-indigo-900 to-purple-900 z-10">
            <div className="text-center">
              <div className="w-24 h-24 mx-auto mb-4 rounded-full bg-gradient-to-br from-blue-400 to-indigo-500 flex items-center justify-center">
                <span className="text-4xl">🧠</span>
              </div>
              <h3 className="text-white text-xl font-bold mb-2">BrainWave AI Tutor</h3>
              <p className="text-gray-300 text-sm mb-6">COPPA-compliant tutoring for elementary students</p>
              <button
                onClick={togglePlay}
        ...
        <video
          ...
          poster=""
        >
          <source src="/videos/brainwave-demo.mp4" type="video/mp4" />
