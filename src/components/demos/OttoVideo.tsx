...
const chapters: Chapter[] = [
  { title: 'Store Setup & Input', startTime: 0, icon: '🏪' },
  { title: 'AI Template Generation', startTime: 30, icon: '🤖' },
  { title: 'Product Upload Demo', startTime: 60, icon: '📦' },
  { title: 'Final Store Preview', startTime: 90, icon: '✨' },
];

export default function OttoVideo() {
  ...
  return (
    <div className="flex flex-col bg-black">
      ...
      <div className="relative aspect-video bg-gray-900">
        ...
        {showPlaceholder && (
          <div className="absolute inset-0 flex items-center justify-center bg-gradient-to-br from-amber-900 to-orange-900 z-10">
            <div className="text-center">
              ...
              <h3 className="text-white text-xl font-bold mb-2">Otto Store Builder</h3>
              <p className="text-gray-300 text-sm mb-6">AI-powered e-commerce template generation</p>
              <button
                onClick={togglePlay}
        ...
        <video
          ...
          poster=""
        >
          <source src="/videos/otto-demo.mp4" type="video/mp4" />
